  ...
  return (
    <main className="sakusiap-home-screen min-h-svh bg-[#edf8f3] text-[#073d33]">
      ...
      <div className="mx-auto hidden min-h-svh w-full max-w-7xl px-8 py-8 lg:block">
        <header className="flex items-center justify-between">
          <Link href="/" prefetch={false} className="flex items-center gap-4">
            <Image
              ...
              height={64}
              priority
              className="h-14 w-14 rounded-[16px] shadow-[0_12px_24px_rgba(5,91,67,0.16)]"
            />
            <span>
        ...
        <section className="mt-8 grid grid-cols-[1.05fr_0.95fr] gap-6">
          <div className="relative min-h-[310px] overflow-hidden rounded-[28px] bg-[#f7fffb] p-8 shadow-[0_18px_48px_rgba(6,78,59,0.08)] ring-1 ring-emerald-900/8">
            <div className="relative z-10 max-w-xl">
              <p className="text-lg font-black text-[#05734d]">Halo, {userName || "Selamat Datang"}!</p>
              <h1 className="mt-3 text-6xl font-black leading-[0.96] text-[#073d33]">Semua siap.</h1>
              <p className="mt-5 max-w-md text-xl font-semibold leading-8 text-[#56746d]">
                Pulsa, tagihan, saldo.
              </p>
            </div>
            <Image
              ...
              priority
              sizes="430px"
              className="absolute bottom-0 right-0 h-auto w-[46%] max-w-[430px] object-contain"
            />
          </div>

          <div className="grid gap-5">
            <section className="overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#056241_0%,#11915f_56%,#70c784_100%)] p-7 text-white shadow-[0_22px_54px_rgba(5,98,65,0.22)]">
              <div className="flex items-start justify-between gap-5">
                <div className="flex min-w-0 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-3 whitespace-nowrap text-6xl font-black leading-none">Rp 250.000</div>
                  </div>
                </div>
                <Link
                  href={links.topup}
                  prefetch={false}
                  className="flex shrink-0 items-center gap-2 rounded-[18px] bg-white px-5 py-3 text-sm font-black text-[#076342] shadow-[0_12px_26px_rgba(0,0,0,0.13)]"
                >
                  <Plus className="h-4 w-4" /> Isi Saldo
                </Link>
              </div>
        ...
        <section className="mt-6 grid grid-cols-[0.95fr_1.05fr] gap-6">
          <Link
            href={links.bill}
            prefetch={false}
            className="grid min-h-[260px] grid-cols-[0.9fr_1.1fr] overflow-hidden rounded-[28px] border border-amber-200/80 bg-[#fff6df] shadow-[0_14px_42px_rgba(86,60,18,0.09)]"
          >
            <div className="relative z-10 p-7">
              <h2 className="max-w-sm text-4xl font-black leading-tight text-[#073d33]">
                Tagihan rumah. Cepat.
              </h2>
              <span className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#075b3e] px-5 py-3 text-sm font-black text-white">
                Bayar <ArrowRight className="h-4 w-4" />
              </span>
            </div>
        ...
        <section className="mt-6 grid grid-cols-[1.1fr_0.9fr] gap-6">
          <section className="rounded-[28px] bg-white p-6 shadow-[0_14px_42px_rgba(6,78,59,0.08)] ring-1 ring-emerald-900/8">
          ...
          <Link
            href={links.bill}
            prefetch={false}
            className="relative flex min-h-[260px] overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#075b3e_0%,#0c7a53_58%,#054b36_100%)] p-7 text-white shadow-[0_22px_54px_rgba(5,98,65,0.18)]"
          >
            <div className="relative z-10">
              <span className="rounded-full bg-white/16 px-3 py-1 text-xs font-black">Promo</span>
              <h2 className="mt-5 text-4xl font-black leading-tight">Cashback Rp 25.000</h2>
              <span className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-black text-[#073d33]">
                Cek <ArrowRight className="h-4 w-4" />
              </span>
            </div>
            <Image
              ...
              width={220}
              height={220}
              className="absolute -bottom-8 right-4 h-56 w-56 object-contain"
            />
          </Link>
        </section>
      </div>
