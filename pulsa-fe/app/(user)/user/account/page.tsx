...
export default async function UserAccountPage() {
  ...
  const settingItems = [
      ...
      : []),
    {
      ...
      desc: "Ketentuan penggunaan SakuSiap",
      icon: FileText,
    },
  ];
      ...
      <div className="mx-auto -mt-4 w-full max-w-md space-y-3.5 px-4">
        <section className="overflow-hidden rounded-[22px] border border-emerald-950/5 bg-white shadow-[0_16px_36px_rgba(6,78,59,0.08)]">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3.5">
            ...
            <Link href="/user/account/edit" className="text-[10px] font-black text-[#21714c]">Edit</Link>
          </div>
            ...
            {personalItems.map((item) => {
              ...
              return (
                <div key={item.label} className="flex items-center gap-3 px-4 py-3.5">
                  <Icon className="h-5 w-5 shrink-0 text-[#21714c]" strokeWidth={1.9} />
        ...
        <p className="pt-2 text-center text-[10px] font-semibold text-slate-400">SakuSiap versi 1.0.0</p>
      </div>
