...
export const metadata: Metadata = buildPageMetadata({
  title: "Paket Data Semua Operator | SakuSiap",
  description: "Beli paket data harian, mingguan, dan bulanan semua operator di SakuSiap dengan pilihan grup produk yang lebih jelas.",
  path: "/paket-data",
