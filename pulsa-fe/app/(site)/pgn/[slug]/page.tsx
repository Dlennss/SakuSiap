...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | SakuSiap",
      description: "Cek dan bayar tagihan gas PGN di SakuSiap.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN SakuSiap`,
    description: `Cek dan bayar tagihan ${brand.nama} di SakuSiap dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
