...
const pageTitle = "Privacy Policy SakuSiap | Website and Android App";
const pageDescription =
  "Privacy policy for SakuSiap website and Android application, including account data, transactions, security, and Google sign-in usage.";
