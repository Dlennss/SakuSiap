...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | SakuSiap",
      description: "Beli paket atau bayar layanan TV berlangganan di SakuSiap.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan SakuSiap`,
    description: `Beli paket atau bayar layanan ${brand.nama} di SakuSiap dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
