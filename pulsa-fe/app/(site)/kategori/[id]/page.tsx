...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | SakuSiap`,
      description: "Layanan digital SakuSiap.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | SakuSiap",
      description: "Lihat kategori produk SakuSiap.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | SakuSiap`,
    description: `Lihat pilihan brand dan produk ${category.nama} di SakuSiap.`,
    path: `/kategori/${id}`,
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | SakuSiap`,
    description: `Lihat pilihan brand dan produk ${categoryName} di SakuSiap.`,
    path: `/kategori/${id}`,
