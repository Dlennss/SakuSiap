...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} SakuSiap`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di SakuSiap.`,
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} SakuSiap`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di SakuSiap.`,
    path: `/kategori/${id}/brand/${brandId}`,
