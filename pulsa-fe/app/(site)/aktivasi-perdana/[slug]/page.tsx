...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | SakuSiap",
      description: "Pilih produk aktivasi perdana operator di SakuSiap.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | SakuSiap`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di SakuSiap. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di SakuSiap dengan pilihan yang jelas.`,
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | SakuSiap`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di SakuSiap dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di SakuSiap tersedia lengkap?`,
      answer: `Ya. SakuSiap menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di SakuSiap?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member SakuSiap untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
