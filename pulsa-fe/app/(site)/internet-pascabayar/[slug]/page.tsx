...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Internet Pascabayar | SakuSiap",
      description: "Cek dan bayar tagihan internet pascabayar di SakuSiap.",
      path: "/internet-pascabayar",
    });
  }

  return buildPageMetadata({
    title: `${toTitleCase(brand.nama)} | Internet Pascabayar SakuSiap`,
    description: `Cek dan bayar tagihan ${toTitleCase(brand.nama)} di SakuSiap dengan proses yang ringkas.`,
...
export default async function InternetPascabayarSlugPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brandTitle} | Internet Pascabayar SakuSiap`,
    description: `Cek dan bayar tagihan ${brandTitle} di SakuSiap dengan proses yang ringkas.`,
    path: `/internet-pascabayar/${slug}`,
