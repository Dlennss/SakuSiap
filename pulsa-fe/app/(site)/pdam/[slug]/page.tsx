...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PDAM | SakuSiap",
      description: "Cek dan bayar tagihan PDAM di SakuSiap.",
      path: "/pdam",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PDAM SakuSiap`,
    description: `Cek dan bayar tagihan ${brand.nama} di SakuSiap dengan proses cepat dan ringkas.`,
    path: `/pdam/${slug}`,
