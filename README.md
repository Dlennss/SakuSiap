...
Dompet harian, hangat dan praktis. Siap untuk sehari-hari.
...
Logo, banner, nama tampilan, metadata, font dan warna memakai identitas SakuSiap.
...
Alamat lokal: http://localhost:3105
...
Konfigurasikan pulsa-be/.env berdasarkan .env.example. Gunakan database sakusiap
dan akun H2HR yang ditetapkan untuk aplikasi ini. Jalankan migrasi sesuai dokumentasi
proyek asal, lalu jalankan go run . dari pulsa-be. Port backend: 8105.
...
lalu arahkan service khusus sakusiap ke release tersebut.
